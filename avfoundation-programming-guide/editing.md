...
> **참고**: 하나 이상의 비디오 트랙을 포함하는 두 개의 에셋과 하나 이상의 오디오 트랙을 포함하는 세 번째 에셋이 있다고 가정한다. 비디오는 카메라 롤에서 검색할 수 있으며 오디오 트랙은 음악 라이브러리 또는 비디오 자체에서 검색할 수 있다.
